...
public class BattleSystem : MonoBehaviour
{
    ...
    public IEnumerator SetupBattle()
    {
        ...
        else
        {
            ...
            yield return _dialogBox.TypeDialog($"{_trainer.Name} sent out {enemyPokemon.Base.Name}");
    ...
    IEnumerator HandlePokemonFainted(BattleUnit faintedUnit)
    {
        ...
        if(!faintedUnit.IsplayerUnit)
        {
         ...
         int expyield=faintedUnit.Pokemon.Base.ExpYield;
            ...
            yield return _dialogBox.TypeDialog($"{_playerUnit.Pokemon.Base.Name} gained  {expGain} exp");
    ...
    IEnumerator ThrowPokeball()
    {
        ...
        if (_isTrainerBattle)
        {
            yield return _dialogBox.TypeDialog($" You can't steal the Trainer's Pokemon!");
            state = BattleState.RunningTurn;
            yield break;
        }
